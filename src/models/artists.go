...
var ArtistWhere = struct {
	...
	ID:        whereHelperstring{field: "\"artists\".\"id\""},
	Name:      whereHelpernull_String{field: "\"artists\".\"name\""},
	SpotifyID: whereHelpernull_String{field: "\"artists\".\"spotify_id\""},
	CreatedAt: whereHelpernull_Time{field: "\"artists\".\"created_at\""},
	UpdatedAt: whereHelpernull_Time{field: "\"artists\".\"updated_at\""},
}
...
var (
	artistAllColumns            = []string{"id", "name", "spotify_id", "created_at", "updated_at"}
	artistColumnsWithoutDefault = []string{"id", "name", "spotify_id", "created_at", "updated_at"}
	artistColumnsWithDefault    = []string{}
