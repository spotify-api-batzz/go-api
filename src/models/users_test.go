...
var (
	userDBTypes = map[string]string{`ID`: `text`, `SpotifyID`: `text`, `Username`: `text`, `Password`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
