...
var UserWhere = struct {
	...
	SpotifyID: whereHelpernull_String{field: "\"users\".\"spotify_id\""},
...
var (
	userAllColumns            = []string{"id", "spotify_id", "username", "password", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "spotify_id", "username", "password", "created_at", "updated_at"}
