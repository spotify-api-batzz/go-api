...
var (
	thumbnailDBTypes = map[string]string{`ID`: `text`, `Entity`: `text`, `EntityID`: `text`, `Width`: `smallint`, `Height`: `smallint`, `URL`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_                = bytes.MinRead
)
